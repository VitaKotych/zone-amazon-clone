        ...
        if (res.status !== 201) {
            ...
            data.carts.forEach((item) => {
                ...
                if (existingItem) {
                    ...
                    combinedCart.push({ ...item, quantity: 1 });
                }
            });
    
            setCartdata(combinedCart);
        }
    };
                                    ...
                                    return (
                                        ...
                                        <img src={e.detailUrl} alt="imgitem" />
                                            <div className="item_details">
                                                ...
                                                <p>Total Quantity: {e.quantity}</p> {/* Display total quantity */}
                                            </div>
                                            <h3 className="item_price">{e.price.cost * e.quantity}.00</h3> {/* Display total price */}
                                        </div>
                                        <Divider />
                                    </>
                                    )
